...
const Instructions = () => {
    return (
        <div className="instBox">
            ...
            <p>
                To start of you can type in anything that you want to look for in the search bar above. 
                This will then search through a couple of websites and give you a few results from them here in one spot.
            </p>
            <p>
                Once you have done that you will be given some either the entire name of the product or a shortend name.
                ...
                That page will have you item on the left and similar items that are cheaper on the right.
            </p>
            <p>
